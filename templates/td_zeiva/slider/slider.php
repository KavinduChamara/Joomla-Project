...
<div class="ls-slide" data-ls="slidedelay:<?php echo $this->params->get('speed'); ?>;transition2d:all;transition3d:;"><img src="<?php echo $base_url; ?>/<?php echo $sliders_thumb1; ?>" class="ls-bg" alt=""/>
</div>
<?php endif;?>
<?php if ($sliders_thumb2): ?>
<div class="ls-slide" data-ls="slidedelay:<?php echo $this->params->get('speed'); ?>;transition2d:all;transition3d:;"><img src="<?php echo $base_url; ?>/<?php echo $sliders_thumb2; ?>" class="ls-bg" alt=""/>
</div>
<?php endif;?>
<?php if ($sliders_thumb3): ?>
<div class="ls-slide" data-ls="slidedelay:<?php echo $this->params->get('speed'); ?>;transition2d:all;transition3d:;"><img src="<?php echo $base_url; ?>/<?php echo $sliders_thumb3; ?>" class="ls-bg" alt=""/>
</div>
<?php endif;?>
<?php if ($sliders_thumb4): ?>
<div class="ls-slide" data-ls="slidedelay:<?php echo $this->params->get('speed'); ?>;transition2d:all;transition3d:;"><img src="<?php echo $base_url; ?>/<?php echo $sliders_thumb4; ?>" class="ls-bg" alt=""/>
</div>
<?php endif;?>
<?php if ($sliders_thumb5): ?>
<div class="ls-slide" data-ls="slidedelay:<?php echo $this->params->get('speed'); ?>;transition2d:all;transition3d:;"><img src="<?php echo $base_url; ?>/<?php echo $sliders_thumb5; ?>" class="ls-bg" alt=""/>
</div>
<?php endif;?>
</div>
<script>
...
skin: 'glass',
hoverBottomNav: true,
skinsPath: '<?php echo $base_url; ?>/templates/td_zeiva/slider/skins/'
});
</script>
